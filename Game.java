...
public class Game {
	...
	public void loadBoard(List<Integer> input) {
		...
		this.theoGUI = new TheoGUI(this.board.getHeight(), this.board.getWidth(), this.board, this);
	...
	public void updateBoard(Board board) throws Exception {
		...
		while (iter.hasNext()) {
			...
			if (board.getIndex(y, x) == true && data.get(ij) < this.x) {
				...
				board.swapIndex(y, x);
				this.board.removeFromLiveSet(x, y);
				counter++;
